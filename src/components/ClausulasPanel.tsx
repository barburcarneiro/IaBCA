...
const ClausulasPanel = () => {
  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden">
      <div className="p-6 border-b border-border flex-shrink-0 bg-secondary-foreground">
        <h2 className="font-display text-sm font-semibold mb-1 bg-secondary-foreground text-primary">
          Buscar Cláusulas
        </h2>
